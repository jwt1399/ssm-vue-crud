  ...
  <el-main>
          ...
          <el-dropdown @command="handleCommand">
            ...
            <template #dropdown>
                <el-dropdown-menu>
                    ...
                    <el-dropdown-item v-for="(item,index) in DeptList" :command="index" :key="index">
                        {{ item.deptName }}
                    </el-dropdown-item>
                </el-dropdown-menu>
            </template>
    ...
    <div class="data-table">
      ...
      >
        ...
        <el-table-column prop="gender" label="性别" :formatter="formatterSex"><el-tag></el-tag></el-table-column>
