  ...
  <el-main>
    ...
    <div class="table-item">
      <!-- <el-dropdown>
        ...
        <el-dropdown @command="dropdownMenu" :tabindex="tabindex">
            <span class="el-dropdown-link">
              {{ tabindex == -1 ? '全部' : departmentList[tabindex].deptName }}
              <i class="el-icon-arrow-down el-icon--right"></i>
            </span>
            <template #dropdown>
                <el-dropdown-menu>
                <el-dropdown-item :command="-1">全部</el-dropdown-item>
                <el-dropdown-item v-for="(item, index) in departmentList" :command="index" :key="index">{{ item.deptName }}</el-dropdown-item>
                </el-dropdown-menu>
            </template>
          </el-dropdown>
      ...
      <div class="table-search">
        <el-input placeholder="请输入名字" v-model="defaultText" size="default"
          :prefix-icon="Search"
          @change="searchChange"
          clearable>
        </el-input>
