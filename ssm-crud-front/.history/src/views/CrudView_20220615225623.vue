...
const paginationSize = ref(false)
...
function getEmployee(empId) {
    ...
    .then(res => {
        // console.log(res.data)
        // console.log(dialog.EmpForm)
        // dialog.EmpForm = res.data.data.emp
        // console.log("测试"+EmpForm)
        console.log("测试"+res.data.data.emp)
    }).catch(error => {
            console.log(error);
        }
    )
