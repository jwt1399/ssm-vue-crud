    ...
    >
      ...
      <el-form-item label="性别" prop="gender">
        <el-radio-group v-model="EmpForm.gender">
          <el-radio :label="1" border size="default"  class="ml-8">男</el-radio>
          <el-radio :label="2" border size="default"  class="ml-8">女</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="部门" prop="department">
        <el-select v-model="EmpForm.department" placeholder="请选择部门">
          <el-option :label="EmpForm.department.deptName" :value="EmpForm.department.deptName"/>
  ...
  axios
    ...
    .then((response) => {
      //   console.log(response.data.data.emp);
        ...
        console.log(EmpForm);
      //   console.log(EmpForm.department);
    })
    .catch((error) => {
        console.log(error);
    });
