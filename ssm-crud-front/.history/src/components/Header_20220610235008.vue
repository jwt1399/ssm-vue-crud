<template>
 <el-header class="header">
    ...
    <div class="nav-item">
        ...
        <el-button type="danger" size="small" @click="batchDeleteEmployee()">删除</el-button>
        <el-button type="default" size="small" :plain="true"  @click="skipAbout()">关于</el-button>
    </div>
    <Dialog ref="dialog"/>
</el-header>
</template>
